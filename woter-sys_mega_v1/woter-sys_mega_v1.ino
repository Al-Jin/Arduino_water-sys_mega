...
#define buttonPin3 11             // Кнопка светодиода закрытия воды на улицу подключена к цифровому выводу D11

#define buttonPin4 14             // Кнопка увеличения полива подключена к выводу D14
#define buttonPin5 15             // Кнопка уменьшения полива подключена к выводу D15
#define buttonPin6 16             // Кнопка ввода полива подключена к выводу D16
...
if(buttonState4 == HIGH){                          // Условие отключения светодиода перекрытия воды на улицу при нажатии кнопки
...
if(p_in > 0 && K1 > 0){                   // Условие вывода времена с момента подачи воды на входе
    myGLCD.print("p>0:", 10, 70);             //Выводим текст в кавычках   +75
