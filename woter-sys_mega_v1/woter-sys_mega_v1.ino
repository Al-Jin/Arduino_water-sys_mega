...
if(millis() - time11 > 1000 && Kpoliv1 == 1){       // Условие вывода информации полив на экран раз в секунду
    time11 = millis();
    myGLCD.print("Vpoliv:", 10, 126);             //Выводим текст в кавычках
    myGLCD.print("L", 210, 126);                 //Выводим текст в кавычках
    myGLCD.setFont(Inconsola);                   //Задаем шрифт выводимого ниже на экран
