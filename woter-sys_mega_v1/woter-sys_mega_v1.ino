...
//    if (K1 == 0){
//    KinOn = 1;                                    // Коэффициент открытия подачи воды в бак.
//    KinOff = 0;
//    }
  }
...
if(p_in == 0 && millis() - time1 > 10000 && K1 == 0){       // Условие включения светодиода когда давление воды на входе равно 0 в течении 5 минут 300000
